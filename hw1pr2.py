...
if __name__ == '__main__':
    ...
    # =============part c: Plot data and the optimal linear fit=================
        ...
        X_space_stacked_t = np.transpose(X_space_stacked)
        W_opt = np.linalg.solve(np.matmul(X_space_stacked_t, X_space_stacked), np.matmul(X_space_stacked_t, y_space_rand))
